  ...
  try {
    ...
    const userEmailTemplate = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #3B82F6;">Thank you for contacting LearningSphere!</h2>
        <p>Dear ${name},</p>
        ...
        <p>Best regards,<br>
        The LearningSphere Support Team</p>
    ...
    try {
      await sendEmail({
        to: email,
        subject: 'Thank you for contacting LearningSphere',
    ...
    try {
      await sendEmail({
        to: process.env.ADMIN_EMAIL || 'admin@LearningSphere.com',
