      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>
                <strong>Growora Academy</strong><br>
                Empowering learners worldwide through personalized education
              </p>
              <p style="margin-top: 10px;">
                Questions? Contact us at <a href="mailto:support@growora.com" style="color: #667eea;">support@growora.com</a>
              </p>
              <p style="margin-top: 15px; font-size: 12px; color: #adb5bd;">
                © 2025 Growora. All rights reserved.
              </p>
            </div>
          </div>
        </body>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              ...
              <p style="margin-top: 10px;">
                Questions? Contact your tutor directly or reach us at <a href="mailto:support@growora.com" style="color: #667eea;">support@growora.com</a>
              </p>
              <p style="margin-top: 15px; font-size: 12px; color: #adb5bd;">
                © 2025 Growora. All rights reserved.
              </p>
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              ...
              <p style="margin-top: 10px;">
                Need help? Contact us at <a href="mailto:support@growora.com" style="color: #28a745;">support@growora.com</a>
              </p>
              <p style="margin-top: 15px; font-size: 12px; color: #adb5bd;">
                © 2025 Growora. All rights reserved.
              </p>
...
exports.sendVerificationEmail = async (to, verifyUrl) => {
  try {
    await sendEmail({
      to,
      subject: '🎉 Welcome to Growora - Verify Your Account',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Verify Your Growora Account</title>
          <style>
            body {
              font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
              line-height: 1.6;
          ...
          <div class="container">
            ...
            <div class="content">
              <div class="welcome-message">
                <h2>🎉 Almost there!</h2>
                <p>Thank you for joining Growora Academy. We're excited to help you on your learning journey!</p>
              </div>
              ...
              <div class="features">
                <h3>🚀 What you can do with Growora:</h3>
              ...
              <div class="support-info">
                ...
                please contact our support team at <a href="mailto:support@growora.com" style="color: #0c5460; font-weight: 500;">support@growora.com</a>
              </div>
            </div>
            ...
            <div class="footer">
              ...
              <div class="footer-links">
                <a href="https://growora.com">Visit Website</a> |
                <a href="https://growora.com/privacy">Privacy Policy</a> |
                <a href="https://growora.com/terms">Terms of Service</a>
              </div>

              <p style="margin-top: 20px; font-size: 12px; color: #adb5bd;">
                © 2025 Growora. All rights reserved.<br>
                This email was sent to you because you registered for a Growora account.
