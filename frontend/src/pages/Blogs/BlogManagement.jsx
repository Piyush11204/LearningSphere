...
import { Plus, Edit, Trash2, Eye, Calendar, User, BarChart3, BookOpen } from 'lucide-react';
...
const BlogManagement = () => {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            await axios.delete(`${API_URLS.BLOGS}/admin/${id}`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <div className="flex items-center">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">LearningSphere Blog Management</h1>
                                <p className="text-gray-600">Manage your educational blog posts and articles</p>
                            </div>
                        </div>
                        <Link
